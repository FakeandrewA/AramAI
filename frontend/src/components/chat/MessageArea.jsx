...
const MessageArea = ({ messages }) => {
  ...
  if (messages.length == 0){
    return <div className="bg to-background h-full  w-[95%]  md:w-[90%] lg:w-[85%] xl:w-[75%] 2xl:w-[65%] space-y-6 flex flex-col items-center justify-center">
          <h1 className="font-goldman text-4xl md:text-6xl opacity-80">Aram AI</h1>
          <p className="opacity-60">Start your conversation with AI for legal insights.</p>
    </div>  
  }
  return (
    <div
            ...
            <div className="flex flex-col max-w-[90%] md:max-w-[80%] ">
              ...
              >
                {message.isLoading ? (
                  ...
                  (message.role === "user" ? message.content : <ReactMarkdown >
      {message.content}
    </ReactMarkdown>) || (
